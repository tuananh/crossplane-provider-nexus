...
PROJECT_REPO ?= github.com/tuananh/$(PROJECT_NAME)

export TERRAFORM_VERSION ?= 1.2.1

export TERRAFORM_PROVIDER_SOURCE ?= nduyphuong/nexus
export TERRAFORM_PROVIDER_REPO ?= https://github.com/nduyphuong/terraform-provider-nexus
export TERRAFORM_PROVIDER_VERSION ?= 1.24.2
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-nexus
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-nexus_1.24.2
